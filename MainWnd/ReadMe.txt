================================================================================
    MICROSOFT FOUNDATION CLASS LIBRARY : MainWnd Project Overview
===============================================================================

The application wizard has created this MainWnd application for 
you.  This application not only demonstrates the basics of using the Microsoft 
Foundation Classes but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your MainWnd application.
...
MainWnd.h
    ...
    project specific headers and declares the CMainWndApp application class.
...
MainWndDlg.h, MainWndDlg.cpp - the dialog
    These files contain your CMainWndDlg class.  This class defines
...
StdAfx.h, StdAfx.cpp
    ...
    named MainWnd.pch and a precompiled types file named StdAfx.obj.
